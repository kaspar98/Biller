...
function getUserByName(firstName, lastName, uid, cb) {
    ...
    pool.query("SELECT firstName, lastName, v_users.id, username FROM v_users WHERE firstName='"+firstName+"' AND lastName='"+lastName+"' NOT EXISTS (SELECT * FROM v_friends " +
